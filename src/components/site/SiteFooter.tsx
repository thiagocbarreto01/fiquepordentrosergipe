    ...
    <footer className="mt-16 bg-navy-deep text-white">
      ...
      <div className="container-news py-12 grid md:grid-cols-4 gap-8 border-t border-white/10">
        <div className="md:col-span-2">
          <img src={logo} alt="Fique Por Dentro Sergipe" className="h-12 w-auto bg-white/95 px-3 py-1 rounded-sm" />
          <p className="mt-4 text-sm text-white/70 max-w-md">
            Fique Por Dentro Sergipe é um portal de notícias com cobertura de política, denúncias, polícia, Brasil e mundo.
      ...
      <div className="border-t border-white/10">
        <div className="container-news py-4 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-white/60">
          <span>© {new Date().getFullYear()} Fique Por Dentro Sergipe. Todos os direitos reservados.</span>
